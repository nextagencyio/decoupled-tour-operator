...
export default function GuideCard({ item }: GuideCardProps) {
  return (
    ...
    >
      <div className="relative h-48 bg-gradient-to-br from-cyan-600 to-cyan-800">
      ...
      <div className="p-6">
          {(item as any).yearsExperience && (
            <p className="text-sm text-cyan-700 font-medium mb-2">{(item as any).yearsExperience}</p>
          )}
        ...
        <div className="flex items-center text-cyan-700 font-medium group-hover:gap-2 transition-all">
          Learn more
