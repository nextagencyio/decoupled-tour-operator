    ...
    <section className="bg-gradient-to-r from-primary-800 to-primary-900 py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/tours" className="px-10 py-4 bg-accent-400 text-primary-900 rounded-full font-bold text-lg hover:bg-accent-300 transition-colors duration-200">{primaryLabel}</Link>
